...
# Isepp Rebane, 5/24/2023, Modified and commited code to master to complete assignment 06
# ---------------------------------------------------------------------------- #
...
class IO:
    ...
    def output_current_tasks_in_list(list_of_rows):
        ...
        :return: nothing
        """
        print("******* The current tasks and priority levels are: *******")
        for row in list_of_rows:
...
while (True):
    ...
    if choice_str.strip() == '1':  # Add a new Task
        ...
        write_data_to_file(file_name=file_name_str, list_of_rows=table_lst)
        table_lst = write_data_to_file(file_name=file_name_str, list_of_rows=table_lst)
        print("Data Saved!")
        continue  # to show the menu
